...
void init_gdtidt(void)
{
	...
	set_gatedesc(idt + 0x0c, (int) asm_inthandler0c-0x280000, 2 * 8, AR_INTGATE32);
	set_gatedesc(idt + 0x0d, (int) asm_inthandler0d-0x280000, 2 * 8, AR_INTGATE32);
	...
	set_gatedesc(idt + 0x40, (int) asm_hrb_api     -0x280000, 2 * 8, AR_INTGATE32+0x60);
